...
class ChoosePokemonWidgetRepositoryTestImpl
    @Inject
    constructor() : ChoosePokemonWidgetRepository {
        override suspend fun savePokemon(pokemon: ChoosePokemonWidgetModel) {
        }

        override suspend fun getPokemon(): ChoosePokemonWidgetModel = PokemonSampleData.choosePokemonWidgetDataSample()
    }
